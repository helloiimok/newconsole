...
@Component({
  selector: 'app-teamauthority',
  templateUrl: './teamauthority.component.html',
  styleUrls: ['./teamauthority.component.css']
})
export class TeamauthorityComponent implements OnInit {
